...
import type {
  ...
  PageResult,
} from "../../src/../src/modules/localization/localization.repository";
import { LocalizationService } from "../../src/../src/modules/localization/localization.service";
...
describe("LocalizationService", () => {
  ...
  it("快照仅使用数据库 repository 的公开市场数据", async () => {
    ...
    expect(repository.listPublicMarkets).toHaveBeenCalledOnce();
  });
