...
- Test: `apps/storefront/src/features/platform/site-shell.test.tsx`
...
- [ ] **Step 2: Run the focused test and confirm the current shell misses the expected contract**

Run: `pnpm --filter @wemo/storefront test -- src/features/platform/site-shell.test.tsx`

Expected: FAIL because the current shell has the compact text-only header/footer structure.

- [ ] **Step 3: Replace the global tokens and shell presentation**
...
```text
git add apps/storefront/src/app/globals.css apps/storefront/src/features/platform/site-shell.tsx apps/storefront/src/app/(public)/layout.tsx apps/storefront/src/app/layout.tsx apps/storefront/src/features/platform/site-shell.test.tsx
...
- Test: `apps/storefront/src/features/public-site/product-card.test.tsx`
...
Run: `pnpm --filter @wemo/storefront test -- src/features/public-site/catalog-adapter.test.ts src/features/public-site/product-card.test.tsx`

Expected: the new media/layout assertions fail against the current flat placeholder card.

- [ ] **Step 3: Implement media-aware editorial cards**
...
- Modify: `apps/storefront/src/features/public-site/product-gallery.tsx`
- Modify: `apps/storefront/src/app/globals.css`
- Test: `apps/storefront/src/features/public-site/filter-bar.test.tsx`
- Test: `apps/storefront/src/features/public-site/product-gallery.test.tsx`
...
- [ ] **Step 1: Add URL and layout tests**
...
- [ ] **Step 2: Run focused tests and confirm the old horizontal filter layout is insufficient**

Run: `pnpm --filter @wemo/storefront test -- src/features/public-site/filter-bar.test.tsx src/features/public-site/product-gallery.test.tsx`

Expected: the new sidebar/media assertions fail before the layout change.

- [ ] **Step 3: Implement catalog and detail layouts**
...
- [ ] **Step 5: Commit the catalog/detail slice**
...
- Test: `apps/storefront/src/features/account/account-shell.test.tsx`
- Test: `apps/storefront/src/features/commerce/cart-adapter.test.ts`
- Test: `apps/storefront/src/features/commerce/quantity-control.test.tsx`
...
- [ ] **Step 1: Add visual structure tests without coupling to CSS implementation**
...
Run: `pnpm --filter @wemo/storefront test -- src/features/account/account-shell.test.tsx src/features/commerce/cart-adapter.test.ts src/features/commerce/quantity-control.test.tsx`

Expected: new source-aligned structure assertions fail before the component changes.

- [ ] **Step 3: Implement account and cart presentation**
...
- [ ] **Step 5: Commit the account/cart slice**
...
- [ ] **Step 2: Inspect the source-aligned routes**
...
- [ ] **Step 3: Verify server HTML and backend fallback behavior**
...
- [ ] **Step 4: Record evidence and update only evidence-backed traceability rows**
